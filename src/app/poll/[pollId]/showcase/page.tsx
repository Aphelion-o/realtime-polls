...
function Clock({ endsAt, paused }: { endsAt?: number; paused?: boolean }) {
  ...
  const seconds = now === null ? 0 : Math.max(0, Math.ceil(((endsAt ?? now) - now) / 1000));
